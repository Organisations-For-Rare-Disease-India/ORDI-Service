...
let clickedDate = {year: new Date().getFullYear(),
month: new Date().getMonth(),
day: null
}
function resolveAppVariable(varName) {
    return clickedDate[varName];
}
...
const manipulate = () => {
  ...
  clickedDate.month=`${months[month]}`
