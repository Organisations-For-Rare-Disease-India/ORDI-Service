...
func CreateDoctorSignupStepsMessage() messages.SignupStepsMessage {
	...
	signupMessage.AddStep(messages.SignupStep{
		Heading: "Build Your Account",
		Body:    "Begin by setting up your account on our platform. Share essential details like your medical credentials and contact information, so we can better understand and connect you with the patients.",
	})
	signupMessage.AddStep(messages.SignupStep{
		Heading: "Verify Your Account",
		Body:    "After entering your details, verify your account by confirming your email, phone number, and any necessary documents. This ensures your information is secure and accurate.",
	...
	signupMessage.AddStep(messages.SignupStep{
		...
		Body:    "Once verified, we’ll connect you with the right patients who is seeking help in your specialized area. We’ll be with you throughout your journey, providing ongoing support and guidance as needed.",
	})
	return signupMessage
}
